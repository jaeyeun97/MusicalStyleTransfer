...
\newlength{svgwidth}
\begin{figure}[h]
    \setlength{\svgwidth}{\textwidth}
    \input{facebook_umtn.pdf_tex}
    \centering
    \caption{\label{fig:facebook_umtn}}
\end{figure}

The Universal Music Translation Network by Mor et al.
...
\hypertarget{wavenet-autoencoder}{%
\paragraph{WaveNet AutoEncoder}\label{wavenet-autoencoder}}
...
can encode temporal features. For Universal Music Translation Network,
we aim to use this Temporal Encoder to extract pitch from the input
audio.
